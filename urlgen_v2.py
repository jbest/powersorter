...
"""
urlgen_v2 takes an output log of powersorter_v2.py and extracts all the web image paths
...
This v2 script has been adapted to work with the output from other v2 scripts.
