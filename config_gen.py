...
web_jpg['file_regex'] = r'(_(?P<suffix>.+))*(\.)(?P<ext>jpg|jpeg)'
...
web_jpg_med['file_regex'] = r'(_(?P<suffix>.+))*(_)(?P<size>med)(\.)(?P<ext>jpg|jpeg)'
web_jpg_med['output_sub_path'] = 'web/TEST/'

web_jpg_thumb = file_types['web_jpg_thumb'] = {}
web_jpg_thumb['file_regex'] = r'(_(?P<suffix>.+))*(_)(?P<size>thumb)(\.)(?P<ext>jpg|jpeg)'
web_jpg_thumb['output_sub_path'] = 'web/TEST/'

archive_dng = file_types['archive_dng'] = {}
archive_dng['file_regex'] = r'(_(?P<suffix>.+))*(\.)(?P<ext>dng)'
archive_dng['output_sub_path'] = 'archive/TEST/'

ocr = file_types['ocr'] = {}
ocr['file_regex'] = r'(_(?P<suffix>.+))*(_ocr)(\.)(?P<ext>txt|json)'
